...
_G.packer_plugins = {
  ...
  ["dark-notify"] = {
    loaded = true,
    path = "/Users/laureanray.bahala/.local/share/nvim/site/pack/packer/start/dark-notify",
  ...
  ["guihua.lua"] = {
    loaded = true,
    path = "/Users/laureanray.bahala/.local/share/nvim/site/pack/packer/start/guihua.lua",
  ...
  ["navigator.lua"] = {
    loaded = true,
    path = "/Users/laureanray.bahala/.local/share/nvim/site/pack/packer/start/navigator.lua",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/Users/laureanray.bahala/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["vim-jsx-pretty"] = {
    loaded = true,
    path = "/Users/laureanray.bahala/.local/share/nvim/site/pack/packer/start/vim-jsx-pretty",
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/Users/laureanray.bahala/.local/share/nvim/site/pack/packer/start/vim-surround",
