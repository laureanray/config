...
_G.packer_plugins = {
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/Users/laureanray.bahala/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["null-ls.nvim"] = {
    loaded = true,
    path = "/Users/laureanray.bahala/.local/share/nvim/site/pack/packer/start/null-ls.nvim",
